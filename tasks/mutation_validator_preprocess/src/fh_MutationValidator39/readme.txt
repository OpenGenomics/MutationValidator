...
================================
-mutation_validator_wrapper.ctf (component technology file)
-mutation_validator_wrapper 
-run_mutation_validator_wrapper.sh (shell script run to temporarily set environment 
                                    variables and execute the application)
   -to run the shell script, type
   
       ./run_mutation_validator_wrapper.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v717, run the shell script as:
       ...
       ./run_mutation_validator_wrapper.sh /mathworks/home/application/v717
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_mutation_validator_wrapper.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
A. Linux x86-64 systems:
   ...
   LD_LIBRARY_PATH by issuing the following commands:
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_mutation_validator_wrapper.sh 
