...
def parseOptions():
    ...
    parser.add_argument( "-e","--extension", type=str, help="extension to be appended to output files.  <input_tsv_stub>.<extension>")
